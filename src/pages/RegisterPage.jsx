...
export const RegisterPage = ({ setActiveTab }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (res.success) {
      ...
      setMsg(res.message || 'تعذر إنشاء الحساب، يرجى التأكد من البيانات أو تجربة اسم مستخدم/بريد مختلف');
    }
  };
      ...
      <div className="panel-right">
        ...
        {isSuccess ? (
          ...
          <div>
            ...
            {msg && <div className="msg error" style={{ background: 'rgba(239,68,68,0.15)', color: '#f87171', border: '1px solid #ef4444', padding: '0.8rem', borderRadius: '8px', marginBottom: '1rem', fontWeight: '600' }}>⚠️ {msg}</div>}
